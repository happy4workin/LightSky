        ...
        <div className="h-screen flex flex-col bg-gray-100">
            <header className="bg-white shadow-sm border-b border-gray-200 flex-shrink-0 z-20">
                <div className="px-6 py-4 flex items-center justify-between">
                    ...
                    >
                        <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-lg mr-3">
                            L
                        </div>
                        ...
                        <button
                            ...
                            className="ml-6 flex items-center px-3 py-1.5 bg-purple-50 hover:bg-purple-100 text-purple-700 rounded-full text-sm font-semibold transition-colors border border-purple-200"
                        >
